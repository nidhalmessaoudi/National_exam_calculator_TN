...
if section == "mathematics" :
    ...
    Result = (Philosophy * 1 + Arabic * 1 + English * 1 + Mathematics * 4 + French * 1 + Physics * 4 + (Informative_written_test + Informative_application_test/2) + Sience * 1 + sport + Optional) / 16
    ...
    print("Sorry,this is for Mathematics, you can go to another link!")